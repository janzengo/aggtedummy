<?php
	...
	if(isset($_SESSION['user'])){
		...
		if(count($_SESSION['cart']) != 0){
			...
			$output .= "
				<tr>
					<td colspan='5' align='center'><i>Note</i>: Please note that the product selected above will only be used as a reference for price quotation purposes and will not be considered as a final product order. If you would like more information, please contact us at quote@aggtedeck.com or call us at 09163770871.</td>
				<tr>
			";
		}
