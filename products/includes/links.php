...
<script src="<?php echo $backRoot; ?>js/bootstrap.min.js"></script>
<script src="<?php echo $backRoot; ?>js/jquery.magnific-popup.min.js"></script>
<script src="https://unpkg.com/imagesloaded@4/imagesloaded.pkgd.min.js"></script>
<script src="<?php echo $backRoot; ?>js/isotope.pkgd.min.js"></script>
<script src="<?php echo $backRoot; ?>js/jquery.fancybox8cbb.js?v=2.1.5"></script>
<script src="<?php echo $backRoot; ?>js/owl.carousel.js"></script>
<script src="<?php echo $backRoot; ?>rs-plugin/js/jquery.themepunch.tools.min.js"></script>
<script src="<?php echo $backRoot; ?>rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
<script src="<?php echo $backRoot; ?>js/counter.js"></script>
<script src="<?php echo $backRoot; ?>js/smoothscroll.js"></script>
